...
if "shares_dict" not in st.session_state:
    ...
    # VW-Bestand initial 5300 € in Euro / Price
...
# --- Übernahme aller Eingaben sofort in session_state ---
...
# --- Umschichtungsvorschläge (nach Zielgewichten) ---
target_weights = {
    "Tech":0.4,
    "Cybersecurity":0.1,
    "Renewable":0.2,
